...
from network.classification_net import ClassificationNet
...
def trainer(train_img_root,
    ...
    net = ClassificationNet(sess=sess,
                            ...
                            pretrained_model='weight/pretrained/model-20190717-030305.ckpt-17902.data-00000-of-00001',
                            width=width,
                            height=height,
                            channels=channels,
                            class_num=class_num
    ...
    net.train(dataset_train=dataset_train,
              ...
              ckpt_path='./weight/train/softmax_resnet'
              )
    sess.close()
